...
public class BlockchainEnergyTest {
    ...
    public void testConsistentEnergyUsage() {
        ...
        AionBlock block = (AionBlock) bc.createNewBlock(bc.getBestBlock(), Collections.EMPTY_LIST, true);
    ...
    public void testEnergyUsageRecorded() {
        ...
        AionBlock block = (AionBlock) bc.createNewBlock(bc.getBestBlock(), txs, true);
        ...
        AionBlock secondBlock = (AionBlock) bc.createNewBlock(bc.getBestBlock(), Collections.EMPTY_LIST, true);
